...
const AboutMe = () => (
    <div className='pt-3' id="about-me" >
        <section  className="pt-5 bg-opacity-50 fade-in section-delay-1">
        <div className="container">
            <h2 className="display-5 fw-bold text-center text-primary mb-5 slide-in section-delay-2">About Me</h2>
            <div className="card bg-black text-light border-primary card-hover mx-auto slide-in section-delay-3" style={{ maxWidth: '960px' }}>
